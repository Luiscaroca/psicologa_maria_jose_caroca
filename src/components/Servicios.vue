  ...
  >
    <div class="row">
      <div
        ...
        id="servicios"
      >
        <div class="col-md-5 mt-3 m-md-0 mx-auto order-2 order-md-1">
          <img
            class="img-fluid"
        ...
        <div class="col-md-7 order-1 order-md-2">
          ...
          <div class="row">
            <p>
              ...
              humanista, lo que significa que mi visión en la terapia es que las
              personas somos integrales, mucho más que síntomas y diagnósticos.
              Los malestares tienen un origen, una razón, un contexto y una
              mirada comprensiva y compasiva puede ayudar a desarticular eso que
